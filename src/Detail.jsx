    ...
    return (
        <>
                            ...
                            {section.products.map((product) => (
                                <div key={product.name} className="product">
                                    <div className='app-container'>
                                        ...
                                        <div>
                                        <p>{product.price}</p>
                                        <button className='buttonadd' onClick={openCart}><FontAwesomeIcon icon={faPlus} /></button>
            ...
            <div className={`cart ${isCartOpen ? 'open' : ''}`}>
                <div>
                    <button className='buttonadd' onClick={closeCart}>X</button>
                    <div className='SanPham'>
                        <img src={comtam}/>
                        <div className='SanPham1'>
                            <h3>Combo Mua 1 Được 3 (bao gồm Cơm Tấm + Canh Rong Biển + Coca M)</h3>
                            <p>Combo bao gồm cơm tấm tuỳ chọn ăn kèm canh rong biển và coca tươi mát lạnh Dùng kèm phần ăn 01 bịch tương cà hoặc 01 bịch tương ớt</p>
                        </div>
                        <p>60.000</p>
                    </div>
                </div>
            ...
            {isCartOpen && (
                <div className='bag2'>
                    <button className='buttondathang'>Đăng nhập để đặt hàng </button>
                </div>
            )}
            </div>
